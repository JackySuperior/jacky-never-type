...
export function getSettings(): AppSettings {
  return {
    ...
    customVocabulary: store.get('customVocabulary'),
    customPrompt: store.get('customPrompt'),
    smartFormatting: store.get('smartFormatting'),
    outputMode: store.get('outputMode'),
    outputLanguage: store.get('outputLanguage'),
    uiLanguage: store.get('uiLanguage'),
    hotkey: store.get('hotkey'),
    showLastHotkey: store.get('showLastHotkey'),
